from ..ops.efficientnet import EfficientNet
from ..ops.utils import relu_fn, url_map, get_model_params, load_pretrained_weights
...
class EfficientNetEncoder(EfficientNet):
    def __init__(self, skip_connections, model_name):
        ...
        self.out_channels = list(efficient_net_encoders[model_name]["out_shapes"])[::-1]
        del self._fc
...
@BACKBONE.register("E-B0-C1-C5")
def build_b0(pretrained=False):
    model_name = 'efficientnet-b0'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
        load_pretrained_weights(model, model_name, True)
    return model

@BACKBONE.register("E-B1-C1-C5")
def build_b1(pretrained=False):
    model_name = 'efficientnet-b1'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B2-C1-C5")
def build_b2(pretrained=False):
    model_name = 'efficientnet-b2'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B3-C1-C5")
def build_b3(pretrained=False):
    model_name = 'efficientnet-b3'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B4-C1-C5")
def build_b4(pretrained=False):
    model_name = 'efficientnet-b4'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B5-C1-C5")
def build_b5(pretrained=False):
    model_name = 'efficientnet-b5'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B6-C1-C5")
def build_b6(pretrained=False):
    model_name = 'efficientnet-b6'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
...
@BACKBONE.register("E-B7-C1-C5")
def build_b7(pretrained=False):
    model_name = 'efficientnet-b7'
    params = efficient_net_encoders[model_name]['params']
    model = EfficientNetEncoder(params['skip_connections'], params['model_name'])
    if pretrained:
